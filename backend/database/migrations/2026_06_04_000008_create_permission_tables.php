...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams, $columnNames) {
            ...
            if ($teams || config('permission.testing')) { // make it compatible with teams if enabled
    ...
    public function down(): void
    {
        ...
        if (empty($tableNames)) {
            throw new \Exception('Error: config/permission.php not found and roles/permissions table names could not be resolved.');
        }
