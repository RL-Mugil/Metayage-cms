...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Read-only connection used exclusively by the AI query service.
        // Point this at a PostgreSQL role that has been granted SELECT-only
        // privileges: GRANT SELECT ON ALL TABLES IN SCHEMA public TO ai_readonly;
        'ai_readonly' => [
            'driver' => 'pgsql',
            'url' => env('DB_URL'),
