            ...
            .map((stage) => {
              ...
              return (
                <View key={stage.id} style={styles.stageRow}>
                  <View style={[styles.stageIcon, { borderColor: color, backgroundColor: stage.status === 'Completed' ? color + '33' : '#040d1a' }]}>
...
const styles = StyleSheet.create({
  ...
  docket:           { color: '#60a5fa', fontFamily: 'monospace', fontSize: 13, fontWeight: '700' },
  badge:            { backgroundColor: 'rgba(96,165,250,0.12)', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 3 },
  badgeText:        { color: '#60a5fa', fontSize: 12, fontWeight: '700' },
  name:             { color: '#f1f5f9', fontSize: 20, fontWeight: '800', letterSpacing: -0.5 },
  client:           { color: '#475569', fontSize: 14, fontWeight: '500' },
  deadline:         { color: '#475569', fontSize: 13 },
  deadlineRed:      { color: '#f87171', fontWeight: '700' },
  segmentBar:       { backgroundColor: '#0b1829', borderBottomColor: 'rgba(100,160,255,0.1)', borderBottomWidth: 1, flexDirection: 'row' },
  segment:          { alignItems: 'center', flex: 1, paddingVertical: 14 },
  segmentActive:    { borderBottomColor: '#f0b23d', borderBottomWidth: 2 },
  segmentText:      { color: '#334155', fontSize: 13, fontWeight: '700' },
  ...
  stageName:        { color: '#94a3b8', fontSize: 15, fontWeight: '600' },
  stageNameActive:  { color: '#f0b23d', fontWeight: '700' },
  ...
  taskTitle:        { color: '#f1f5f9', flex: 1, fontSize: 15, fontWeight: '700' },
  taskStatus:       { color: '#475569', fontSize: 13 },
  taskDue:          { color: '#334155', fontSize: 12 },
  smallBadge:       { borderRadius: 6, paddingHorizontal: 7, paddingVertical: 2 },
  smallBadgeText:   { fontSize: 11, fontWeight: '700' },
  teamRow:          { borderBottomColor: 'rgba(100,160,255,0.06)', borderBottomWidth: 1, flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 14 },
  teamLabel:        { color: '#475569', fontSize: 14 },
  teamName:         { color: '#f1f5f9', fontSize: 14, fontWeight: '600' },
